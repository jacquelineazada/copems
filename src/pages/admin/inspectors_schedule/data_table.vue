          ...
          <v-row>
            <v-col cols="12" sm="6" md="4">
              <v-card class="status-card" color="#6394FF">
                <div class="d-flex justify-space-between align-center">
                  <div>
                    <div class="text-subtitle-1">Total Schedules</div>
                    <div class="card-number-total mt-2">3</div>
                  </div>
                  <v-icon size="48" color="#FFFFFF">mdi-calendar-check</v-icon>
                </div>
              </v-card>
            </v-col>
            <v-col cols="12" sm="6" md="4">
            ...
            <v-col cols="12" sm="6" md="4">
              <v-card class="status-card" color="#41E27D">
                <div class="d-flex justify-space-between align-center">
                  <div>
                    <div class="text-subtitle-1">Scheduled</div>
                    <div class="card-number-approved mt-2">1</div>
                  </div>
                  <v-icon size="48" color="#FFFFFF">mdi-calendar-month</v-icon>
                </div>
              </v-card>
            </v-col>
          </v-row>
            ...
            <v-col cols="12">
              <v-card class="elevation-1">
                <v-table class="applicants-table">
                  <thead>
                    <tr>
                      <th class="text-left text-subtitle-2" style="width: 35%">
                        Applicant Name
                      </th>
                      <th class="text-left text-subtitle-2" style="width: 20%">
                        Application Number
                      </th>
                      <th class="text-left text-subtitle-2" style="width: 20%">
                        Inspection Date
                      </th>
                      <th class="text-left text-subtitle-2" style="width: 15%">Status</th>
                      <th class="text-left text-subtitle-2" style="width: 10%">Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      <td>
                        <v-avatar
                          size="36"
                          class="mr-2 avatar-style"
                          style="background-color: #c8e6c9; color: #388e3c"
                          >JD</v-avatar
                        >
                        Conrad Fisher
                      </td>
                      <td>BP-2024-808124-T</td>
                      <td>Jan 16, 2024</td>
                      <td>
...
.applicants-table th {
  ...
  border-bottom: 2px solid #e0e0e0; /* Added a subtle line */
}

.applicants-table td {
  font-weight: 400 !important;
  color: #333333;
  padding: 16px; /* Added more padding for spacing */
