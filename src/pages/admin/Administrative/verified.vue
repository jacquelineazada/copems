          ...
          <v-card class="header-card" flat>
            <v-card-text class="d-flex align-center">
              <v-avatar size="56" rounded="lg" class="mr-4 applicant-avatar">
                <span class="text-h5 font-weight-bold">SG</span>
              </v-avatar>
              <div class="d-flex flex-column">
                <h1 class="header-title">Sarah Geronimo</h1>
                <p class="header-email">sarahgerons23@yahoo.com</p>
                <p class="header-application-id">BP-2024-808234-T</p>
              </div>
              <v-spacer></v-spacer>
              <div class="d-flex flex-column align-end">
                <v-chip size="default" class="status-chip mb-2 verified-chip">
                  ...
                  <v-row>
                    <v-col cols="12" md="6">
                      <div class="info-block">
                        ...
                        <div class="info-value">Sarah Geronimo</div>
                      </div>
                      <div class="info-block">
              ...
              <v-card class="section-card" flat>
                ...
                <v-list class="py-0">
                  ...
                  >
                    ...
                    <template v-slot:append>
                      <div class="d-flex align-center">
                        <v-chip color="green" variant="tonal" size="small" class="mr-4">
              ...
              <v-card class="section-card" flat>
                ...
                <v-card-text>
                  ...
                  >
                    ...
                    <v-timeline-item dot-color="success" size="x-small">
                      <div class="timeline-title">Documents Verified</div>
                      <div class="timeline-time">Jan 16, 2024 - 09:00 AM</div>
                    </v-timeline-item>
...
export default {
  setup() {
    ...
    // Schedule Inspection Dialog state
    ...
    // --- NEW: Returned Application Dialog state ---
    ...
    const selectedReasons = ref([]); // Changed from selectedReason to handle multiple values
    ...
    // --- MODIFIED: This function now opens the new return dialog ---
    const handleReturn = () => {
      console.log(`${selectedDocTitle.value} is being returned.`);
      dialogVisible.value = false; // Close document viewer
      returnDialogVisible.value = true; // Open return dialog
    };

    const handleVerify = () => {
      console.log(`${selectedDocTitle.value} has been verified.`);
      dialogVisible.value = false; // Close document viewer
      scheduleDialogVisible.value = true; // Open schedule dialog
    };

    // Functions for the Schedule Dialog
    ...
    // --- NEW: Functions for the Return Dialog ---
    const closeReturnDialog = () => {
      returnDialogVisible.value = false;
      selectedReasons.value = []; // Reset array
    ...
    const confirmRejection = () => {
      ...
      alert("Application has been returned."); // Placeholder
      closeReturnDialog();
    };
    ...
    return {
      ...
      closeScheduleDialog,
      sendSchedule,
      // --- NEW: Exported refs and functions for return dialog ---
      returnDialogVisible,
      rejectionReasons,
      selectedReasons,
...
/* MODIFIED: Responsive header card */
.header-card {
  background-color: #ffffff;
  border-radius: 12px;
  margin-bottom: 34px;
...
/* ADDED: Style for the new verified chip */
.verified-chip {
  background-color: #ecfdf5; /* Light green */
  color: #065f46; /* Dark green */
}
.verified-chip :deep(.v-icon) {
...
/* Styles for Schedule Inspection Dialog */
.schedule-card {
...
/* Styles for Returned Application Dialog */
.return-card {
  border-radius: 12px !important;
}
.return-header {
